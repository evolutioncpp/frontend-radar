...
import type { CiAnalysis } from './reportCiAnalyzer.js';
import type { DependencyHealth } from './reportDependencyAnalyzer.js';
import type { ToolingSource } from './reportToolingSources.js';
...
export type CollectRepositorySignalsInput = {
  ...
  projectPath: string;
  reader: import('./githubRepositoryReader.js').GithubRepositoryReader;
  repository: string;
